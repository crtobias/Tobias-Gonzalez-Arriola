...
export default function Screen2() {
    return (
        <div className=" border-t border-black flex flex-col justify-center items-center  ">
            ...
            <h2 className="text-3xl p-9 pl-9 border-b border-black w-full text-black">More About Me</h2>

            <div className="max-w-[80vw] m-9 border-b border-gris pb-9 sm:max-w-[60vw]">
                <h6 className="text-2xl text-black" >About Me</h6>
                <br />
            ...
            <div className="max-w-[80vw] m-9 border-b border-gris pb-9 sm:max-w-[60vw]">
                <h6 className="text-2xl text-black" >Carrer Overview</h6>
                <br />

                <h6 className="text-xl text-black">2024</h6>
                <br />
                ...
                <br />
                <h6 className="text-xl text-black">2023</h6>
                <br />
            ...
            <h2 className="text-2xl text-black">Languages & Tools</h2>
            <Tools></Tools>
